...
<html lang='ru'>
	<?php 
		...
		$head_subtitle = 'Косметическая продукция'; 
		...
		<div class="wrapper">
			...
			<main>
				<?php 
					...
					$subheader_title_content = 'Косметическая продукция';
				...
				<?php 
					...
					$founder_title = 'Контрактное производство косметической продукции';
				...
				<?php 
					$fabric_title = 'Изготовление косметической продукци';
				...
				?>
				<?php 
					$autohim_type_title = 'Виды косметической продукци';
