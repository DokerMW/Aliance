		...
		<div class="wrapper">
			...
			<main>
				<?php 
					...
					$subheader_title_content = 'Бытовая химия';
				...
				<?php 
					...
					$founder_title = 'Контрактное производство бытовой химии';
				...
				<?php 
					$fabric_title = 'Изготовление бытовой химии';
				...
				?>
				<?php 
					$autohim_type_title = 'Виды бытовой химии';
