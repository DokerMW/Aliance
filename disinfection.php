...
<html lang='ru'>
	<?php 
		...
		$head_subtitle = 'Дезинфицирующие средства'; 
		...
		<div class="wrapper">
			...
			<main>
				<?php 
					...
					$subheader_title_content = 'Дезинфицирующие средства';
				...
				<?php 
					...
					$founder_img = 'img/autohim/founder-autohim.webp';
					$founder_title = 'Контрактное производство дезинфицирующих средств';
				...
				<?php 
					$fabric_title = 'Изготовление дезинфицирующих средств';
					...
					$fabric_img = 'img/autohim/fabric-autohim.webp';
					include_once('./template_parts/fabric.php');
				?>
				<?php 
					$autohim_type_title = 'Виды дезинфицирующих средств';
