...
<html lang='ru'>
	<?php 
		...
		$head_subtitle = 'Пищевые аэрозоли'; 
		...
		<div class="wrapper">
			...
			<main>
				<?php 
					...
					$subheader_title_content = 'Пищевые аэрозоли';
				...
				<?php 
					...
					$founder_title = 'Контрактное производство пищевых аэрозолей';
				...
				<?php 
					$fabric_title = 'Изготовление пищевых аэрозолей';
				...
				?>
				<?php 
					$autohim_type_title = 'Виды пищевых аэрозолей';
